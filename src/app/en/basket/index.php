	...
	switch ($_POST['post-identifier']) {
		...
		case "checkout":
			try {
				...
				if($db->exec($sql)) {
					$checkoutFeedback = "The items were successfully purchased!";
				};
...
<html lang="en">
	<head>
		...
		<title>Accidental Founds | Basket</title>
	</head>
	<body>
			...
			<div class="container">
				<main>
							...
							<li>
								<section>
									<section class="info">
										...
										<p>Amount: <?php echo $basket['quantity'] ?></p>
										<p class="price">&euro; <?php echo $product['price']*$basket['quantity'] ?></p>
										<a href="../webshop/webshop-item/?id=<?php echo $product['productId'] ?>">Product page</a>
									</section>
					...
					<section class="checkout">
						...
						<a href="../webshop">Continue Shopping</a>
